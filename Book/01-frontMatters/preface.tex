...
\vspace{0.5cm}
\begin{minipage}{9cm}
\emph{Denis Bouyssou}, \emph{Luis Dias},\\ 
\emph{Claude Lamboray}, \emph{Patrick Meyer}\\
\emph{Vincent Mousseau}, \emph{Alex Olteanu}\\
\emph{Marc Pirlot}, the late \emph{Bernard Roy},\\
\emph{Alexis Tsouki\`as}, \emph{Thomas Veneziano}\\
and especially, the late \emph{Marc Roubens}.
\end{minipage}
% \quad
% \begin{minipage}{3cm}
