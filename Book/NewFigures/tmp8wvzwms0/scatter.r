...
test.mat <- matrix(scan("compolg.prn"),ncol=5,byrow=T)
lim1 <- max(test.mat)
lim2 <- min(test.mat)
choose12<-c(5,4)
choose23<-c(4,3)
...
pdf("/Users/bisdorff/rbisdorff.github.io/Book/NewFigures/correlation.pdf",width=6,height=6,bg="cornsilk",title="PCA of Criteria Correlation Index")
par(mfrow=c(2,2))
...
barplot(valprop[nrow(valprop):2,2]*100,names.arg=c(1:4),main="Axis inertia (in %)",col="orangered")
dev.off()
