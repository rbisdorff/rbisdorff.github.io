...
Before showing the \emph{ranking-by-choosing} result, we have to compute the iterated bipolar selection procedure (see List.~\vref{list:7.10} Line 1).\index{showRankingByChoosing@\texttt{showRankingByChoosing()}}
