...
Published data of the 2004 \emph{Spiegel} student survey is stored, for our evaluation purpose here, in a file named \texttt{studentenSpiegel04.py} of \texttt{PerformanceTableau} format Footnote[32].
