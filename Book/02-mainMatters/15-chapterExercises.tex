...
File \texttt{graffiti03.py}\footnote{Source: \citet{GRA-2003}. The file is provided in the \texttt{examples} directory of the \Digraph ressources.} contains a performance tableau about the rating of movies that could be seen in the city of Luxembourg during Spring 2003. Its content is shown in Fig.~\vref{fig:15.1}.
\begin{lstlisting}
