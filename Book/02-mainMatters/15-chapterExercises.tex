...
File \texttt{graffiti03.py} \footnote{The file is provided in the \texttt{examples} directory of the \Digraph ressources \citep{BIS-2021b}.} contains a performance tableau about the star-rating of movies that could be seen in the city of Luxembourg during Spring 2003 (source: \citet{GRA-2003}). Its content is shown in Fig.~\vref{fig:15.1}.
\begin{lstlisting}
...
\begin{figure}[h]
%\sidecaption
\includegraphics[width=\hsize]{Figures/15-1-moviesRatingData.png}
...
A person, who wants to buy a TV set, retains after a first selection, eight potential TV models \footnote{This didactic decision problem is discussed in \citet[pp.33-35]{VIN-1992}}. To make their best choice these eight models were graded with respect to three decision objectives of equal importance:
