...
\abstract{ The chapter introduces bipolar-valued undirected graphs and illustrates several special graph models and methods like Q-coloring, MIS and clique enumeration, line graphs and maximal matchings, grid graphs, and $n$-cycle graphs with their non-isomorphic maximal independent sets of vertices.}
