...
The two last MISs of cardinality 4 (see Lines~\ref{line:21.9.13}-\ref{line:21.9.16} 13-16 in List.~\vref{list:21.9}) give perfect maximum matchings of the 8-cycle graph as shown in Figure~\vref{fig:21.3}. 
...
\noindent The next Chapter~\ref{sec:22} is devoted more specifically to tree graphs and graph forests.
