...
\begin{itemize}
\item We say that decision alternative $x$ \emph{robustly outranks} decision alternative $y$ when:
\begin{itemize}
...
\end{itemize}
\item Dually, we say that decision alternative $x$ \emph{does not robustly outrank} decision alternative $y$ when:
\begin{itemize}
...
\begin{itemize}
\item We say that decision alternative $x$ \emph{unopposedly outranks} decision alternative $y$ when  $x$ positively outranks $y$ on one or more decision objectives without $x$ being positively outranked by $y$ on any decision objective.
\item Dually, we say that decision alternative $x$ \emph{is unopposedly outranked by} decision alternative $y$ when $x$ is positively outranked by $y$ on one or more decision objectives without $x$ positively outranking $y$ on any decision objective.
\end{itemize}
\end{definition}
