...
\end{lstlisting}
Alternative \texttt{p4} is indeed  unanimously ``\emph{at least as well assessed as}'' alternative \texttt{p5} and $r(p4 \succsim p5)\; =\; 72/72\; =\; +1.00$ (see Listing \ref{list:19.4} Line 11).
