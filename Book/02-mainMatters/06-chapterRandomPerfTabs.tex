...
\vspace{1cm}
Useful multiple incommensuarble criteria ranking rules are presented and discussed in detail in Chapter~\ref{sec:8}. In the next Chapter~\ref{sec:7}, we first show how to compute the winner of an election on the basis of a different kind of performance evaluation models, namely \emph{linear voting profiles} who are discussed in social choice theory.
