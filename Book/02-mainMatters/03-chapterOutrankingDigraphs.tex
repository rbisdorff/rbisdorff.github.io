...
\vspace{\baselineskip}
In the next methodological Part III, we present and discuss multiple-criteria evaluation models and decision algorithms, like building a best choice recommendation, determining the winner of an election, computing linear rankings or quantile ratings with multiple incommensurable criteria.
