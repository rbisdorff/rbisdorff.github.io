...
Given the previous random performance tableau \texttt{pt}, the {\tt BipolarOutranking\-Digraph}\index{BipolarOutrankingDigraph@\texttt{BipolarOutrankingDigraph}} constructor computes the corresponding \emph{bipolar-valued outranking digraph}. 
