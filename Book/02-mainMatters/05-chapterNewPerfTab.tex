...
The next Chapter~\ref{sec:6} describes \Digraph resources for generating random multiple-criteria performance tableaux of various kinds like Cost-Benefit, three-objectives or academic tableaux.
...
%\input{02-mainMatters/05-chapterNewPerfTab.bbl}
