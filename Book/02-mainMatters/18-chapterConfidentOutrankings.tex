...
\item An expected minority of criteria at confidence level $-\alpha\%$ or lesser, validates a global ``\emph{performing at least as well as}'' situation between $x$ and $y$, and
