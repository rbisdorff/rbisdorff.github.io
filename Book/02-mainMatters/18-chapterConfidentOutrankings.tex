...
\begin{figure}[ht]
%\sidecaption
\includegraphics[width=\hsize]{Figures/simulLikelihood.pdf}
...
>>> gu90.showRelationTable()
  * ---- Outranking Relation Table -----
  ...
  -------|-------------------------------------------------------
    ...
    Determinateness    : 0.24 (62.1%)
\end{lstlisting}
Despite lower likelihood values (see the $g90$ relation in Listing~table above), we keep the same confident majority level of $57.1\%$ (see List.~\vref{list:18.5} Line 25 above) and, hence, also the same $90\%$-confident outranking digraph.
