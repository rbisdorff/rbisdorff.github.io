...
For the corresponding confident outranking digraph, we assume uncertain criteria significance weights of \emph{triangular} distribution and require a confidence level of $\alpha = 90\%$.
