...
\vspace{\baselineskip}
The next case study in Chap.~\ref{sec:14} is tackling the absolute quantile rating of the student enrolment quality of higher education institutions.
%%%%%%% The chapter bibliography
%\normallatexbib
%\clearpage
%\phantomsection
%\addcontentsline{toc}{section}{Chapter Bibliography}
\input{Bibliographies/13-chapterBestCSDpts.bbl}
