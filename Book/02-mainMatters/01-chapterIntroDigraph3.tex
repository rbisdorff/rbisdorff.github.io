...
Some types of universal digraph instances, like the \texttt{CompleteDigraph}, the \texttt{EmptyDigraph} or the \texttt{GridDigraph}\index{GridDigraph@texttt{GridDigraph} class} classes, are readily available (see Fig. \ref{fig:1.3}).
\begin{figure}[h]
\sidecaption[t]
\includegraphics[width=5.5cm]{Figures/1-3-tutorialGrid.pdf}
