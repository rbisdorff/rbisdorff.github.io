...
\begin{itemize}
\item To be fully functional, the \Digraph resources mainly need the \texttt{graphviz} tools \footnote{\href{https://graphviz.org}{https://graphviz.org}} and the R statistics resources \footnote{\href{https://www.r-project.org}{https://www.r-project.org}} to be installed.
...
Different \texttt{show...()} methods (see Listing \ref{list:1.3}  Lines 1, 16, 26, 31 below) reveal us now that $dg$ is a crisp, irreflexive and connected digraph of order five.
