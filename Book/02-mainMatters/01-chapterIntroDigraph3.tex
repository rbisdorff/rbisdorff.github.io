...
Different \texttt{show...()} methods, like the \texttt{showShort()} method \index{showSort@\texttt{showShort()}}, reveal us now that \texttt{dg} is a crisp, irreflexive and connected digraph of order five (see List.~\vref{list:1.3}  Lines 1, 16, 26, 29).
