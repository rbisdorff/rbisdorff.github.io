\contentsline {lstlisting}{\numberline {1.1}Generating a digraph instance}{14}{lstlisting.1.1}%
\contentsline {lstlisting}{\numberline {1.2}A stored digraph instance}{15}{lstlisting.1.2}%
\contentsline {lstlisting}{\numberline {1.3}Random crisp digraph object}{16}{lstlisting.1.3}%
\contentsline {lstlisting}{\numberline {1.4}Inspecting a \texttt {Digraph} object}{18}{lstlisting.1.4}%
\contentsline {lstlisting}{\numberline {1.5}Various \texttt {compute...()} methods.}{18}{lstlisting.1.5}%
\contentsline {lstlisting}{\numberline {1.6}Circulant digraphs and $n \times m$ grid digraphs}{20}{lstlisting.1.6}%
\contentsline {lstlisting}{\numberline {2.1}Random bipolar-valued digraph instance}{21}{lstlisting.2.1}%
\contentsline {lstlisting}{\numberline {2.2}Example of random valuation digraph}{22}{lstlisting.2.2}%
\contentsline {lstlisting}{\numberline {2.3}Computing asymmetric and symmetric Parts}{24}{lstlisting.2.3}%
\contentsline {lstlisting}{\numberline {2.4}Computing the asymmetric part of a bipolar-valued relation}{24}{lstlisting.2.4}%
\contentsline {lstlisting}{\numberline {2.5}Border and inner part of a linear order}{25}{lstlisting.2.5}%
\contentsline {lstlisting}{\numberline {2.6}Epistemic fusion of partial diagraphs}{26}{lstlisting.2.6}%
\contentsline {lstlisting}{\numberline {2.7}Computing associated dual, converse and codual digraphs}{27}{lstlisting.2.7}%
\contentsline {lstlisting}{\numberline {2.8}Computing the dual, the converse and the codual of a digraph}{28}{lstlisting.2.8}%
\contentsline {lstlisting}{\numberline {2.9}Symmeric and transitive closures}{29}{lstlisting.2.9}%
\contentsline {lstlisting}{\numberline {2.10}Computing the strong components in a digraph}{30}{lstlisting.2.10}%
\contentsline {lstlisting}{\numberline {2.11}Complete, empty and indeterminate digraphs}{32}{lstlisting.2.11}%
\contentsline {lstlisting}{\numberline {3.1}Generating a random performance tableau.}{38}{lstlisting.3.1}%
\contentsline {lstlisting}{\numberline {3.2}Inspecting the performance criteria.}{39}{lstlisting.3.2}%
...
\contentsline {lstlisting}{\numberline {5.2}Example of decision alternative description}{67}{lstlisting.5.2}%
\contentsline {lstlisting}{\numberline {5.3}Example of decision objectives' description}{68}{lstlisting.5.3}%
\contentsline {lstlisting}{\numberline {5.4}Example of performance criteria description}{69}{lstlisting.5.4}%
\contentsline {lstlisting}{\numberline {5.5}Example of cardinal \emph {Costs} criterion}{70}{lstlisting.5.5}%
...
\contentsline {lstlisting}{\numberline {7.4}Example of {\sc Borda}\xspace rank scores}{95}{lstlisting.7.4}%
\contentsline {lstlisting}{\numberline {7.5}Rank analysis example with {\sc Borda}\xspace scores}{95}{lstlisting.7.5}%
...
\contentsline {lstlisting}{\numberline {8.12}Computing a {\sc Slater}\xspace ranking}{117}{lstlisting.8.12}%
...
\contentsline {lstlisting}{\numberline {10.10}From deciles interpolated quartiles rating result}{144}{lstlisting.10.10}%
...
\contentsline {lstlisting}{\numberline {13.1}Performance tableau of the}{175}{lstlisting.13.1}%
\contentsline {lstlisting}{\numberline {13.2}Printing the CS Departments}{176}{lstlisting.13.2}%
\contentsline {lstlisting}{\numberline {13.3}The THE ranking objectives}{177}{lstlisting.13.3}%
\contentsline {lstlisting}{\numberline {13.4}Computing the THE overall scores}{178}{lstlisting.13.4}%
\contentsline {lstlisting}{\numberline {13.5}Printing the ranked performance table}{179}{lstlisting.13.5}%
\contentsline {lstlisting}{\numberline {13.6}Inspecting the performance discrimination thresholds}{181}{lstlisting.13.6}%
\contentsline {lstlisting}{\numberline {13.7}Computing the robust outranking digraph}{182}{lstlisting.13.7}%
\contentsline {lstlisting}{\numberline {13.8}Inspecting outranking circuits}{183}{lstlisting.13.8}%
\contentsline {lstlisting}{\numberline {13.9}Showing the relation table with stability denotation}{184}{lstlisting.13.9}%
\contentsline {lstlisting}{\numberline {13.10}Computing a robust {\sc NetFlows}\xspace ranking}{185}{lstlisting.13.10}%
\contentsline {lstlisting}{\numberline {13.11}Comparing the robust {\sc NetFlows}\xspace ranking with the THE ranking}{185}{lstlisting.13.11}%
\contentsline {lstlisting}{\numberline {13.12}Comparing pairwise criteria performances}{187}{lstlisting.13.12}%
\contentsline {lstlisting}{\numberline {13.13}Measuring the quality of the {\sc NetFlows}\xspace ranking result}{189}{lstlisting.13.13}%
\contentsline {lstlisting}{\numberline {13.14}Measuring the consensus quality of the {\sc NetFlows}\xspace ranking result}{190}{lstlisting.13.14}%
\contentsline {lstlisting}{\numberline {13.15}Showing the ordinal correlation between the marginal criterion relations}{190}{lstlisting.13.15}%
\contentsline {lstlisting}{\numberline {13.16}Computing the ordinal quality of the THE ranking}{192}{lstlisting.13.16}%
...
\contentsline {lstlisting}{\numberline {17.13}Computing the prekernels of the strict outranking digraph \texttt {gcd}}{240}{lstlisting.17.13}%
